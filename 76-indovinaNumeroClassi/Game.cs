public class Game{
    ...
    private List<int> _gameNumbersAttempted;
    private int _specificGameId = 0;
    private int _numberToHit = -1;
    private int _hints = 7;
    private int _attempts = 1;
    public List<int> NumbersAttempted{get{return _gameNumbersAttempted;}}
    ...
    public Game(){
        ...
        _gameNumbersAttempted = new List<int>();
        _gameId++;
    }

    public int ChechNumber(int value){
        _gameNumbersAttempted.Add(value);
